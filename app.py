...
app.config['SQLALCHEMY_DATABASE_URI']='mysql+pymysql://MoniMelgarejo:VqmW2d4hUJDAg@MoniMelgarejo.mysql.pythonanywhere-services.com/MoniMelgarejo$default'
...
class Oferta_educativa(db.Model):   # la clase Oferta_educativa hereda de db.Model
    ...
    def __init__(self,carrera,duracion,tecnologias,image):   #crea el  constructor de la clase
...
class Oferta_educativa_schema(ma.Schema):
    class Meta:
        fields=('id','carrera','duracion','tecnologias','image')
...
def create_oferta():
    ...
    new_oferta=Oferta_educativa(carrera,duracion,tecnologias,image)
